...
define("EWRPT_PROJECT_ID", "{9C34E0AE-3D93-4927-9AF2-4F86A6FC81EE}", TRUE); // Project ID // ### v5.0.2
define("EWRPT_PROJECT_NAME", "roadCover", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "roadCover", TRUE); // Project Var
...
define("EWRPT_CHARSET", "utf-8", TRUE); // Project charset
...
define("EWRPT_RANDOM_KEY", '&FFs1j284hfntPST', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phprptcss/roadCover.css", TRUE); // Project stylesheet file name
...
// User admin
define("EWRPT_LOGIN_SELECT_SQL", "SELECT * FROM `roadCover_users`", TRUE);

// User table filters
define("EWRPT_USER_TABLE", "`roadCover_users`",  TRUE);
...
?>
<?php
define("EWRPT_PDF_STYLESHEET_FILENAME", "", TRUE); // export PDF CSS styles
?>
<?php
