...
$RootMenu->AddMenuItem(62, $ReportLanguage->Phrase("ChartReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("62", "MenuText") . $ReportLanguage->Phrase("ChartReportMenuItemSuffix"), "dealers_transactionsmry.php#cht_Dealers_deal_sold", 49, "", "", IsLoggedIn(), FALSE);
