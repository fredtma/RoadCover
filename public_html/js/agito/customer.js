...
tmp={
   ...
   "children":{
      ...
      "payment":{"icon":"icon-tags ","title":"View customer's finances","global":{"complex":true,"type":"span"},"fields":{"AccountType_cd":{"title":""},"BankAccountNo":{"title":""},"FirstDebitDate":{"title":""},"MonthlyDebitDay":{"title":""},"ApplicationType_cd":{"title":""},"PurchasePurpose_cd":{"title":""},"CustomerType_cd":{"title":""},"RequestedInterestRate":{"title":""},"PaymentFrequency_cd":{"title":""},"ContractPeriod":{"title":""},"RateType_cd":{"title":""},"RequestedResidual":{"title":""},"RequestedResidualPercentage":{"title":""},"FinanceHouse_cd":{"title":""},"ConsentCreditBuro":{"title":""},"ConfirmLOAReceived":{"title":""},"SourceOfDeposit_cd":{"title":""},"Deposit":{"title":""},"Discount":{"title":""},"PrincipalDebt":{"title":""}}},
      "cover":{"icon":"icon-download-alt ","title":"View customer's cover","global":{"complex":true,"type":"span"},"fields":{}}
   }
}
